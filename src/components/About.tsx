          ...
          <div className="marquee-scroll">
            ...
            <div className="marquee-group">
              <div className="review-card">
                ...
                <p>"Kristoffer didn't just deliver a visual identity, he captured our mission in every pixel. The process was collaborative, insightful, and creatively sharp. We've never felt more confident in our brand."</p>
                <div className="author">
                  <img src="https://i.pravatar.cc/150?img=47" alt="Jenna Morales" />
                  <div>
              ...
              <div className="review-card">
                ...
                <p>"Working with Staugaard Studio was like having an in-house design team. They understood our product's core value proposition from day one. The new website helped us triple our conversion rate in the first month."</p>
                <div className="author">
              ...
              <div className="review-card">
                ...
                <p>"The attention to detail and strategic thinking they brought to the table completely transformed our digital presence. Our engagement metrics have been climbing steadily since launch."</p>
                <div className="author">
      ...
      <div className="toolbox-block">
        ...
        <div className="icons-area">
          ...
          <div className="icons-scroll">
            <div className="icon-box"><Figma size={22} /></div>
            <div className="icon-box"><Layout size={22} /></div>
            <div className="icon-box"><Framer size={22} /></div>
            <div className="icon-box"><Code size={22} /></div>
            <div className="icon-box"><Box size={22} /></div>
            <div className="icon-box"><Github size={22} /></div>
          </div>
        </div>
      </div>
    </section>
